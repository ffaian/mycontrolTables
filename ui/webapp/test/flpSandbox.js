		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori WorkList V2",
									"targetURL": "#FioriWorkListV2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FioriWorkListV2-display": {
								"semanticObject": "FioriWorkListV2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mycontroltables.ui",
									"url": sap.ui.require.toUrl("mycontroltables/ui")
								}
							}
						}
					}
